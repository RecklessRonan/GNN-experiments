...
# alpha, beta, gamma, norm_func_id, norm_layers, order_func_id, orders
best_config = {
...
# weight_decay = [0.0, 1e-07, 1e-06, 5e-05, 0.0001, 0.0005]
...
with open('config_list5', 'wb') as f:
    pickle.dump(config_list, f)

with open('run5.sh', 'w') as f:
    f.write(run_sh_all)
