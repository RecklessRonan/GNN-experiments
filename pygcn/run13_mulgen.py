...
best_config = {
    'chameleon': [0.01, 0.0, 200, 0.0, 0.0, 100000000.0, 0.0, 2, 1, 1.0, 1, 2],
    'squirrel': [0.01, 0.0, 200, 0.0, 0.0, 100000000.0, 0.0, 1, 1, 1.0, 1, 2],
    'cora': [0.01, 0.8, 40, 0.00001, 0.0, 1000.0, 0.8, 2, 4, 1.0, 1, 2],
    'citeseer': [0.01, 0.7, 40, 0.00001, 0.0, 1000.0, 0.8, 2, 3, 1.0, 1, 2],
    'pubmed': [0.01, 0.3, 40, 0.00001, 0.0, 1000.0, 0.8, 1, 4, 1.0, 1, 2],
    'texas': [0.01, 0.0, 200, 0.00005, 0.0, 0.1, 0.1, 2, 1, 1.0, 1, 2],
    'wisconsin': [0.01, 0.0, 200, 0.00005, 0.1, 1.0, 0.0, 2, 1, 1.0, 1, 2],
