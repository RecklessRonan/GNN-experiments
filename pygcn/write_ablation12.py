...
best_config12 = {
    ...
    'texas': [0.01, 0.0, 200, 0.00005, 10.0, 0.01, 0.0, 1, 2, 1.0, 1, 2],
    'wisconsin': [0.01, 0.0, 200, 0.00001, 0.5, 0.5, 0.0, 3, 5, 1.0, 1, 2],
...
with open('ablation12', 'wb') as f:
    pickle.dump(config_list, f)

with open('run_ablation12.sh', 'w') as f:
    f.write(run_sh_all)
